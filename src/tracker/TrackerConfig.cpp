...
const char* TrackerConfig::moduleExtensions[] = 
{
	"669","Composer669",
...
const char* TrackerConfig::instrumentExtensions[] = 
{
	"xi","FT2 Instruments",
	"pat","GUS Patches",
	NULL, NULL
...
const char* TrackerConfig::sampleExtensions[] = 
{
...
const char* TrackerConfig::patternExtensions[] = 
{
	"xp","FT2 Pattern",
	NULL, NULL
};

const char* TrackerConfig::trackExtensions[] = 
{
	"xt","FT2 Track",
	NULL, NULL
};
