...
PPGraphics_RGBA32::PPGraphics_RGBA32(pp_int32 w, pp_int32 h, pp_int32 p, void* buff) :
	PPGraphicsAbstract(w, h, p, buff)
{
}

void PPGraphics_RGBA32::setPixel(pp_int32 x, pp_int32 y)
{
...
#ifdef __ppc__
		buff[1] = (pp_uint8)currentColor.b;
		buff[2] = (pp_uint8)currentColor.g;
		buff[3] = (pp_uint8)currentColor.r;		
#else
...
void PPGraphics_RGBA32::setPixel(pp_int32 x, pp_int32 y, const PPColor& color)
{
	if (y >= currentClipRect.y1 && y < currentClipRect.y2 &&
		x >= currentClipRect.x1 && x < currentClipRect.x2)
	{
...
void PPGraphics_RGBA32::fill(PPRect rect)
{
...
void PPGraphics_RGBA32::fill()
{
	fill(currentClipRect);
}

void PPGraphics_RGBA32::drawHLine(pp_int32 x1, pp_int32 x2, pp_int32 y)
{
	...
	pp_uint32 rgb1 = (((pp_uint32)currentColor.b) << 16) +
...
void PPGraphics_RGBA32::drawVLine(pp_int32 y1, pp_int32 y2, pp_int32 x)
{
...
void PPGraphics_RGBA32::drawLine(pp_int32 x1, pp_int32 y1, pp_int32 x2, pp_int32 y2)
{
	__PPGRAPHICSLINETEMPLATE	
}

void PPGraphics_RGBA32::drawAntialiasedLine(pp_int32 x1, pp_int32 y1, pp_int32 x2, pp_int32 y2)
{
	__PPGRAPHICSAALINETEMPLATE
}

void PPGraphics_RGBA32::blit(SimpleBitmap& bitmap, PPPoint p)
{
...
void PPGraphics_RGBA32::blit(const pp_uint8* src, const PPPoint& p, const PPSize& size, pp_uint32 pitch, pp_uint32 bpp, pp_int32 intensity/* = 256*/)
{
	...
	if (intensity != 256)
	{
		for (pp_int32 y = 0; y < h; y++)
		{
			...
			{	
#ifdef __ppc__				
				dst[1] = (src[2]*intensity)>>8;
				dst[2] = (src[1]*intensity)>>8;
				dst[3] = (src[0]*intensity)>>8;
#else
...
void PPGraphics_RGBA32::drawChar(pp_uint8 chr, pp_int32 x, pp_int32 y, bool underlined/* = false*/)
{
...
void PPGraphics_RGBA32::drawString(const char* str, pp_int32 x, pp_int32 y, bool underlined/* = false*/)
{
	if (currentFont == NULL)
		return;
...
void PPGraphics_RGBA32::drawStringVertical(const char* str, pp_int32 x, pp_int32 y, bool underlined/* = false*/)
{
	if (currentFont == NULL)
		return;
