...
PPGraphics_BGRA32::PPGraphics_BGRA32(pp_int32 w, pp_int32 h, pp_int32 p, void* buff) :
	PPGraphicsAbstract(w, h, p, buff)
{
}

void PPGraphics_BGRA32::setPixel(pp_int32 x, pp_int32 y)
{
...
void PPGraphics_BGRA32::setPixel(pp_int32 x, pp_int32 y, const PPColor& color)
{
	if (y >= currentClipRect.y1 && y < currentClipRect.y2 &&
		x >= currentClipRect.x1 && x < currentClipRect.x2)
	{
...
void PPGraphics_BGRA32::fill(PPRect rect)
{
...
void PPGraphics_BGRA32::fill()
{
	fill(currentClipRect);
}

void PPGraphics_BGRA32::drawHLine(pp_int32 x1, pp_int32 x2, pp_int32 y)
{
...
void PPGraphics_BGRA32::drawVLine(pp_int32 y1, pp_int32 y2, pp_int32 x)
{
...
void PPGraphics_BGRA32::drawLine(pp_int32 x1, pp_int32 y1, pp_int32 x2, pp_int32 y2)
{
	__PPGRAPHICSLINETEMPLATE
}

void PPGraphics_BGRA32::drawAntialiasedLine(pp_int32 x1, pp_int32 y1, pp_int32 x2, pp_int32 y2)
{
	__PPGRAPHICSAALINETEMPLATE
}

void PPGraphics_BGRA32::blit(SimpleBitmap& bitmap, PPPoint p)
{
...
void PPGraphics_BGRA32::blit(const pp_uint8* src, const PPPoint& p, const PPSize& size, pp_uint32 pitch, pp_uint32 bpp, pp_int32 intensity/* = 256*/)
{
...
void PPGraphics_BGRA32::drawChar(pp_uint8 chr, pp_int32 x, pp_int32 y, bool underlined/* = false*/)
{
...
void PPGraphics_BGRA32::drawString(const char* str, pp_int32 x, pp_int32 y, bool underlined/* = false*/)
{
	if (currentFont == NULL)
		return;
...
void PPGraphics_BGRA32::drawStringVertical(const char* str, pp_int32 x, pp_int32 y, bool underlined/* = false*/)
{
	if (currentFont == NULL)
		return;
